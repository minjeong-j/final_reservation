...
<body>
    ...
    <div id="content">
        ...
        <form method="post" name="f">
            <table>
                ...
                <tr>                
                    ...
                    <td><textarea name="content" class="contentR">${post.content }</textarea></td>
                </tr>
            </table>
        </form>
        </div>  
        ...
        <div class="postEdit">
			<input type="button" value="글 수정하기" onclick="modifyPostReview()">
		</div>
		
    </div>
	<jsp:include page="/WEB-INF/views/footer.jsp"/>
    <script type="text/javascript">
    function modifyPostReview() {
		...
		f.action = "${pageContext.request.contextPath}/moo/reviewModify";
		f.submit();
	}
    </script>
</body>
