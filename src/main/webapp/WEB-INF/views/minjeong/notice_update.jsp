...
<body>
    ...
    <div id="content">
        ...
        <form method="post" name="f">
            <table>
                ...
                <tr>                
                    ...
                    <td><textarea name="content" class="contentN">${post.content }</textarea></td>
                </tr>
            </table>
        </form>
        </div>  
        ...
        <div class="postEdit">
			<input type="button" value="글 수정하기" onclick="modifyPostNotice()">
		</div>
		
    </div>
	<jsp:include page="/WEB-INF/views/footer.jsp"/>
    <script type="text/javascript">
    function modifyPostNotice() {
		...
		f.action = "${pageContext.request.contextPath}/moo/noticeModify";
		f.submit();
	}
    </script>
</body>
