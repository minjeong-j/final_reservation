...
<body>
    ...
    <div id="content">
        ...
        <div class="postEdit">
			...
			<input type="button" value="목록으로" onclick="location.href='${pageContext.request.contextPath}/moo/noticeView'">
		</div>
    ...
    function updatePost() {
		location.href = "${pageContext.request.contextPath}/moo/noticeUpdate?id=${post.id}";
	}
	function deletePost() {
		if (window.confirm("정말 삭제하시겠습니까?")) {
			location.href = "${pageContext.request.contextPath}/moo/noticeDelete?id=${post.id}";
		}
	}
    </script>
</body>
