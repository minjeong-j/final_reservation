...
<html>
    <head>
        ...
        <style>
            *{
            ...
            .li_box > ul > li:first-child {
                width: 85%;
                padding: 15px;
                font-weight: 600;
                color: #888;
            }
            .li_box > ul > li:nth-child(2) {
                position: absolute;
                top: 15px;
                right: 15px;
            }
        ...
        <script>
            $(document).ready(function(){
                ...
                */
                ...
                //전체선택 전체해제
	            $(".join_box").on("click", "#allCheck", function() {
	            	var checked = $(this).is(":checked");
	            	
	            	if(checked) {
	            		$(this).parents(".join_box").find("input[name=check]").prop("checked", true);
	            	} else {
	            		$(this).parents(".join_box").find("input[name=check]").prop("checked", false);
	            	}
	            });
                
                //전체선택 후 하나만 해제했을 때 전체선택 해제
                ...
                //개별 선택으로 전체가 선택이 되었을 때 전체선택에도 체크
                $(".join_box").on("click", ".normal", function(){
                	var is_checked = true;
                ...
                $(".foot_btn").click(function(){
              	   if($("#allCheck").is(":checked") == false) {
              		 alert("이용약관과 개인정보 수집 및 이용에 모두 동의 해주세요.");
              		 return false;
              	   } else {
              		 agreementForm.action = "${pageContext.request.contextPath}/member/joinForm";
    ...
    <jsp:include page="/WEB-INF/views/header.jsp"/>
        <div id="container">
            <form action="" id="joinForm" name="agreementForm">
                <ul class="join_box">
                    <li class="li_box">
                        <ul class="clearfix">
                            <li>
...
2) 시행일자 : 2018년 05월 01일 
                ...
                <ul class="foot_btn_box">
                    <li><button class="foot_btn" type="submit">동의</button></li>
                </ul>
            </form>
        </div>
    </body>
